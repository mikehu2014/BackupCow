...
type
  ...
  public
    ...
    class procedure ShowMoblieBoxBtn;
    class procedure ShowStorageBtn;
  end;
...
class procedure MyHintAppApi.ShowStorageBtn;
var
  ShowStorageBtnFace : TShowStorageBtnFace;
begin
  ShowStorageBtnFace := TShowStorageBtnFace.Create;
  ShowStorageBtnFace.AddChange;
end;
...
class procedure MyHintAppApi.ShowMoblieBoxBtn;
var
  ShowMoblieBoxBtnFace : TShowMoblieBoxBtnFace;
begin
  ShowMoblieBoxBtnFace := TShowMoblieBoxBtnFace.Create;
  ShowMoblieBoxBtnFace.AddChange;
end;
