...
{$Region ' Hint 显示 ' }
  ...
  TShowMoblieBoxBtnFace = class( TFaceChangeInfo )
  protected
    procedure Update;override;
  end;

  TShowStorageBtnFace = class( TFaceChangeInfo )
  protected
    procedure Update;override;
  end;
...
{$Region ' Form Debug ' }
  ...
  TFormLogAddSendFace = class( TFaceChangeInfo )
  public
    LogStr : string;
  public
    constructor Create( _LogStr : string );
...
constructor TFormLogAddSendFace.Create(_LogStr: string);
begin
  LogStr := _LogStr;
end;

procedure TFormLogAddSendFace.Update;
begin
  inherited;

    // 最多一千行
  if frmDebug.mmoSend.Lines.Count > 1000 then
    frmDebug.mmoSend.Lines.Clear;

  frmDebug.mmoSend.Lines.Add( LogStr );
end;

{ TShowMoblieBoxBtnFace }

procedure TShowMoblieBoxBtnFace.Update;
begin
...
procedure TShowStorageBtnFace.Update;
begin
