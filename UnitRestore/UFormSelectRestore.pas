...
procedure TfrmSelectRestore.Button1Click(Sender: TObject);
begin
  frmRestoreChildTo.Height := Self.Height;
...
begin
  Params := _Params;
    ...
    // 基本信息
  edtPath.Text :=  Params.OwnerPcName + ' ' + Format( DesName_Show, [Params.RestorePath] );
