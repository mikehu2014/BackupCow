...
begin
  ...
  Path := NetworkDesItemUtil.getCloudPath( DesItemID );
  IsLanPc := MyNetPcInfoReadUtil.ReadIsLanPc( NetworkDesItemUtil.getPcID( DesItemID ) );

  RestoreDesAddNetworkFace := TRestoreDesAddNetworkFace.Create( DesItemID );
  RestoreDesAddNetworkFace.SetDesInfo( PcName, Path );
  RestoreDesAddNetworkFace.SetIsLanPc( IsLanPc );
...
begin
  ...
  if NetworkDesItemUtil.getPcID( DesItemID ) = PcInfo.PcID then
    StorageApi.AddMyComputer( MyFilePath.getPath( NetworkDesItemUtil.getCloudPath( DesItemID ) ) + OwnerID, Format( ShowName_NetworkBackups, [OwnerName] ), FileSize );
end;
...
begin
  ...
  MyRestoreHandler.AddRestoreJob( LocalRestorePathInfo );
end;
...
begin
  ...
  MyRestoreHandler.AddRestoreJob( NetworkRestorePathInfo );
end;
...
begin
  ...
  MyRestoreExplorerHandler.AddRestoreJob( RestoreScanLocalExplorerInfo );
end;
...
begin
  ...
  MyRestoreExplorerHandler.AddRestoreJob( RestoreScanNetworkExplorerInfo );
end;
...
begin
  ...
  StorageApi.AddMyComputer( DesItemID, ShowName_MyLocalBackups, FileSize );
end;
...
begin
  ...
  MyRestoreSearchHandler.AddRestoreJob( RestoreScanLocalSearchInfo );
end;
...
begin
  ...
  MyRestoreSearchHandler.AddRestoreJob( RestoreScanNetworkSearchInfo );
end;
...
begin
  ...
  MyRestorePreviewHandler.AddRestoreJob( LocalRestorePreviewInfo );
end;
...
begin
  ...
  MyRestorePreviewHandler.AddRestoreJob( NetworkRestorePreviewInfo );
end;
