...
{$EndRegion}
  ...
  public
    ...
    class procedure SetDeviceType( PcID : string; DeviceType : string );
  public
...
var
  ...
  NetPortMapWriteXml : TNetPortMapWriteXml;
begin
  MyPcStatusUpnpPortMapFace := TMyPcStatusUpnpPortMapFace.Create( IsCompleted );
  MyPcStatusUpnpPortMapFace.AddChange;

  NetPortMapWriteXml := TNetPortMapWriteXml.Create;
  NetPortMapWriteXml.SetIsPortMap( IsCompleted );
  NetPortMapWriteXml.AddChange;
end;
...
class procedure NetworkPcApi.SetDeviceType(PcID, DeviceType: string);
var
  NetPcSetDeviceTypeInfo : TNetPcSetDeviceTypeInfo;
begin
  NetPcSetDeviceTypeInfo := TNetPcSetDeviceTypeInfo.Create( PcID );
  NetPcSetDeviceTypeInfo.SetDeviceType( DeviceType );
  NetPcSetDeviceTypeInfo.Update;
  NetPcSetDeviceTypeInfo.Free;
end;
