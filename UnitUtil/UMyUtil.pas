...
type
  ...
  public
    ...
    class function getBigStr( Str : string ): string;
  public
...
const
  BackupShow_MyComputer = 'My Computer';
  BackupShow_SharedFolder = 'Network shared folder';
  DesName_Show = '( %s )';
...
begin
  ...
  if SplitList.Count >= 4 then
    Result := IntToStr( 15150 + StrToInt( SplitList[3] ) );
...
class function MyHtmlHintShowStr.getBigStr(Str: string): string;
begin
...
begin
  ...
  Result := StrToFloatDef( TimeStr, IncYear( Now, 500 ) );
end;
