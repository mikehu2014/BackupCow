...
type
  ...
  public
    ...
    class function getNetworkPc : Integer;
    class function getNetworkSpace : Integer;
  protected
    class function getImageListName : string;override;
  end;
...
const
  ...
  ShellTranAction_NetworkPc = 14;
  ShellTranAction_NetworkSpace = 15;
...
class function MyShellTransActionIconUtil.getNetworkPc: Integer;
begin
  Result := getShellIcon( ShellTranAction_NetworkPc );
end;

class function MyShellTransActionIconUtil.getNetworkSpace: Integer;
begin
  Result := getShellIcon( ShellTranAction_NetworkSpace );
end;
