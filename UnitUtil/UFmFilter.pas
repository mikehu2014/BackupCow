...
type
  ...
  public
    ...
    function ReadExistPath : Boolean;
...
procedure TFrameFilter.AddPath(Path: string);
begin
  AddPathMask( Path );
end;
...
function TFrameFilter.ReadExistPath: Boolean;
begin
  Result := LvMask.Items.Count > 0;
end;

function TFrameFilter.ReadPathList: TStringList;
var
  i: Integer;
  ItemData : TLvMaskData;
begin
  ...
  begin
    ItemData := LvMask.Items[i].Data;
    if ItemData.MaskType = FilterType_Path then
      Result.Add( ItemData.MaskStr );
  end;
end;
